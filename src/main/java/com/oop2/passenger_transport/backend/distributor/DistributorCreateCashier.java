package com.oop2.passenger_transport.backend.distributor;
...
public class DistributorCreateCashier {
    ...
    private final static Logger logger = LoggerFactory.getLogger(com.oop2.passenger_transport.backend.admin.AdminCreateTravelCompany.class);
